<x-filament-panels::page>
    <style>
        ...
        @media print {
            ...
            nav, header:not(.print-area header),
            .filament-sidebar, .filament-topbar,
            .filament-header, .filament-main-topbar,
            .filament-global-search, .filament-footer,
            .print-hide, #navbar, .navigation, .nav-menu {
        ...
        .invoice-wrapper {
            ...
            @apply bg-gray-100 dark:bg-gray-900; /* Background yang responsive terhadap mode */
            ...
            <header class="border-b border-gray-100 p-6 sm:p-8 no-break" role="banner">
                ...
                <div class="flex items-center justify-between gap-6 sm:gap-8">
                    <div class="relative">
                        ...
                        <p class="mt-2 text-lg sm:text-xl text-black/80">NO. FAKTUR: {{ $this->record->invoice_number }}</p>
                    </div>
                    ...
                    <section class="space-y-4 no-break">
                        <div>
                            <h3 class="text-lg font-semibold text-black flex items-center">
                                Detail Proyek: {{ $this->record->project->project_name }}
                            </h3>
                            ...
                            <table class="w-full">
                                <tbody>
                                    ...
                                    <tr class="border-b border-gray-200">
                                        ...
                                        <td class="p-3 font-medium text-right text-black">
                                            Rp {{ number_format(($this->record->project->price * $this->record->tax_amount) / 100, 0, ',', '.') }}
                                        </td>
                                    </tr>
                                    <tr class="border-b border-gray-200">
            ...
            <footer class="mt-6 pt-4 border-t border-gray-200 px-4 pb-4 no-break">
                ...
                <div class="text-center mt-6">
                    <p class="text-base text-black/80 italic">
                        "Heyoo! Makasih banyak ya <b>{{ $this->record->project->user?->name ?? 'Pengguna Sudah Dihapus' }}</b> sudah percaya sama Artelia.DEV!
                    </p>
                    <p class="text-base text-black/80 italic mb-2">Semoga projectnya sukses dan kita bisa kolaborasi lagi di project selanjutnya!"</p>
